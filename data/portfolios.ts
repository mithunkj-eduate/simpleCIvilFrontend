...
export const samplePortfolioData: PortfolioData = {
  ...
  about: {
    ...
    description:
      "A passionate cardiologist committed to delivering world-class cardiac care. Trained at AIIMS Delhi and Johns Hopkins, Dr. Sharma combines cutting-edge medical science with genuine compassion. She believes every patient deserves personalized attention and a clear understanding of their health journey.",
    image:
...
export const portfolioRegistry: Record<string, PortfolioData> = {
  "dr-priya-sharma": samplePortfolioData,
};

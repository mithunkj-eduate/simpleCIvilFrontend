  ...
  return (
    <div className="bg-white ">
      ...
      <div className="mx-auto max-w-7xl mt-16 px-4 py-12 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">All Payments</h1>
            ...
            <thead className="bg-gray-50">
              <tr>
                {[
                  ...
                  { name: "Transaction ID", className: "px-6 py-3 hidden sm:table-cell" },
                  { name: "Created At", className: "px-6 py-3 hidden sm:table-cell" },
